...
public class TransitionsHeaderTest {
    ...
    public void Logo() {
        var chtenie = new pages.c_skorochtenieTeachers.Header();
        chtenie.buttonMainLogo();
